...
<div class="portlet light bordered">
    <div class="portlet-title">
        ...
        <div class="btn-group" style="margin-right:10px ;">
            <a class="btn btn-default mt-ladda-btn ladda-button btn-outline" href="{{ route('dashboard.ImamText.create',$id) }}"> <i class="fa fa-plus"></i> اضافة</a>
