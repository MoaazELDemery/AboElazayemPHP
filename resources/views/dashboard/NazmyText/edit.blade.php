...
<div class="portlet light form-fit bordered">
    <div class="portlet-title">
        <div class="caption">
            ...
            <span style="color:#000 !important;" class="caption-subject font-green bold uppercase"> تعديل البيانات نبذة عن الكتاب  /  التراث  النظمي      </span>
        </div>
        <div class="actions">
    ...
    <div class="portlet-body form">
        ...
        <form  class="form-horizontal form-bordered" method="POST" action="{{ route('dashboard.NazmyText.update', $Texts->id) }}" enctype="multipart/form-data">
            @csrf
            <div class="form-body">
            ...
            <div class="form-actions">
                <div class="row">
                    <div class="col-md-offset-3 col-md-9">
                        ...
                        <a href="{{ route('dashboard.NazmyText.index',$id_button)}}" class="btn default">الغاء</a>
                    </div>
                </div>
            </div>
        </form>
