...
<div class="portlet light form-fit bordered">
    <div class="portlet-title">
        <div class="caption">
            ...
            <span style="color:#000 !important;" class="caption-subject font-green bold uppercase"> تعديل البيانات اسماء الائمة و التلاميذ </span>
        </div>
        <div class="actions">
    ...
    <div class="portlet-body form">
        ...
        <form  class="form-horizontal form-bordered" method="POST" action="{{ route('dashboard.ImamDisciples.update', $Librarys->id) }}" enctype="multipart/form-data">
            @csrf
            <div class="form-body">
                    ...
                    <div class="col-md-4">
                        <div class="fileinput fileinput-new" data-provides="fileinput">
                            <div class="fileinput-new thumbnail" style="width: 200px; height: 150px;">
                                ...
                                <img src="{{asset('storage/ImamDisciples/img/'.$Librarys->photo)}}" alt="Image" style="width:100%;height:100%;">
                            </div>
