...
<div class="portlet light form-fit bordered">
    <div class="portlet-title">
        <div class="caption">
            ...
            <span style="color:#000 !important;" class="caption-subject font-green bold uppercase"> ادخل البيانات الكتاب /  التراث  النظمي </span>
        </div>
        <div class="actions">
    ...
    <div class="portlet-body form">
        ...
        <form class="form-horizontal form-bordered" method="POST" action="{{ route('dashboard.NazmyBook.store')}}" enctype="multipart/form-data">
            @csrf
            <div class="form-body">
            ...
            <div class="form-actions">
                <div class="row">
                    <div class="col-md-offset-3 col-md-9">
                        ...
                        <a href="{{ route('dashboard.NazmyBook.index',$id)}}" class="btn default">الغاء</a>
                    </div>
                </div>
            </div>
        </form>
