            ...
            <div class="filter">
                <div class="shikh-flex shikh-icon bg-about" style="margin-top: 80px; ">
                    <div class="col-md-12 wow animate__backInRight" data-wow-duration="2s">
                        ...
                        @if($index == 0)
                        <h1 style="text-align: center; ">{{$Book->EltasofLibrary->name_ar}}</h1>
                        @endif
                        @endforeach
                    </div>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-md-4 pull-right ">
                    <div class="voice-clip bg-about">
                        <a href="{{route('eltasofpdf',$Book->id)}}">
                            <img src="{{ asset('storage/EltasofBook/img/' . $Book->photo) }}" alt="{{ $Book->name_ar }}">
                            <h4> {{ $Book->name_ar }} </h4>
                        </a>
        ...
        <div class="col-md-3 wow animate__backInRight" data-wow-duration="2s">
            <div class="filter">
                ...
                <div id="search" class="bor-sold">
                    <form action="{{ route('eltasofgroup',$id) }}" method="GET">
