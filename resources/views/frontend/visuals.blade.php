            ...
            <div class="filter">
                <div class="shikh-flex shikh-icon bg-about" style="margin-top: 80px; ">
                    ...
                    <div class="col-md-12 wow animate__backInRight" data-wow-duration="2s">
                        ...
                        <h1 style="text-align: center;  padding: 10px;">{{__('messages.visual')}}</h1>
    ...
    <div class="row reverse-col    div-flex-flex">
        <div class="col-md-9 wow animate__backInUp" data-wow-duration="2s">
            ...
            <div class="card col-md-3 student-card pull-right one bg-about">
                <a href="{{route('visuals2',$sheikh->id)}}">
                ...
                <div class="card-body">
                    <h3 class="card-title"> <a  href="{{route('visuals2',$sheikh->id)}}"><i class="fas fa-bookmark"></i>{{ $sheikh->name_ar }} </a> </h3>
                </div>
            </div>
            @else
            ...
            <div class="card col-md-3 student-card pull-right one bg-about">
                ...
                <div class="card-body">
                    <h3 class="card-title"> <a class="menu-flex" href="{{route('visuals2',$sheikh->id)}}"><i class="fas fa-bookmark"></i>{{ $sheikh->name_en }} </a> </h3>
                </div>
            </div>
            @endif
            @endif
        ...
        <div class="col-md-3 wow animate__backInRight " data-wow-duration="2s">
            <div class="filter">
                ...
                <div id="search" class="bor-sold">
                    <form action="visuals" method="GET">
