...
@section('content')
    < <!-- start service-single-section -->
        <section class="service-single-section group section-padding wow animate__backInUp" data-wow-duration="2s">
            <div class="container">
                <div class="row">
                                    ...
                                    <div class="box-border service-single-item" style="height: 120px;">
                                        <div class="service-text bg-about">
                                            <h4 style="text-align: center;"><a
                                                    href="{{ route('ProseCategorie', $Library->id) }}"
                                                    style="color: #444 !important; font-size:20px;">
                                                    {{ $Library->name_ar }} </a></h4>
                                        </div>
                                    </div>
                                </div>
                            @endif
